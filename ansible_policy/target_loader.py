...
from ansible_policy.policy_input import PolicyInput, load_input_from_project_dir


@dataclass
class TargetLoader(object):
    def run(self, target_type: str, target_path: str, target: str, raw_ansible_file: str="") -> List[PolicyInput]:
        pass
